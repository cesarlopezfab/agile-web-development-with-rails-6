...
class Order < ApplicationRecord
    ...
    def charge!(pay_type_params)
        payment_method, payment_details = get_payment_method_and_details_from pay_type_params
    ...
    private
        def get_payment_method_and_details_from(pay_type_params)
            payment_details = {}
            payment_method = nil
            case pay_type
            when "Check"
            ...
            when "Credit card"
                ...
                month,year = pay_type_params[:expirateion_date].split(//)
